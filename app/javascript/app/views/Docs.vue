      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-10 lg:max-w-none lg:grid-cols-12">
          ...
          <div class="max-w-xl text-base leading-7 text-gray-700 lg:col-span-7">
            ...
            <ol>
              <li>
                  <a href="#quick-start" title="Inicio Rápido">Inicio Rápido</a>
                  <ul>
                      <li><a href="#installation" title="Instalación">Instalación</a></li>
                      <li><a href="#dependencies" title="Dependencias">Dependencias</a></li>
                      <li><a href="#database" title="Database">Database</a></li>
                  </ul>
              </li>
              <li>
                  <a href="#layout" title="Layouts">Layouts</a>
                  <ul>
                      <li>Application</li>
                      <li>Devise</li>
                      <li>Admin</li>
              ...
              <li>
                  <a href="/docs/seo" title="SEO">SEO</a>
                  <ul>
                      <li><a href="/docs/seo#sitemap" title="Sitemap">Sitemap</a></li>
                      <li><a href="/docs/seo#jsonld" title="JSON-LD">JSON-LD</a></li>
                      <li><a href="/docs/seo#metadata" title="Metadata">Metadata</a></li>
                      <li><a href="/docs/seo#og" title="Open-Graph">Open-Graph</a></li>
                  </ul>
              </li>
              <li>
                  <a href="/docs/server" title="Server">Server</a>
                  <ul>
                      <li><a href="/docs/optimization" title="Optimización">Optimización</a></li>
                      <li><a href="/docs/server" title="Caché">Caché</a></li>
                  </ul>
              </li>
          </ol>
          </div>
